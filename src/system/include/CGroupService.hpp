...
public:
  ...
  [[nodiscard]] static bool setMemoryLimit(const CGroup &cgroup,
                                           size_t max_bytes);
  [[nodiscard]] static bool setProcLimit(const CGroup &cgroup, int max_pids);
  [[nodiscard]] static bool setCpuLimit(const CGroup &cgroup,
  ...
  enableSubtreeControllers(const CGroup &parent_cgroup);
  [[nodiscard]] static bool writeCG(const CGroup &cgroup,
